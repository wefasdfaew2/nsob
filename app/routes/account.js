...
module.exports.bind = function(routes, controllers) {
    ...
    routes.add({
        uri: '/account',
        func: controllers.account.index
    });

    routes.add({
        uri: '/account/ads',
        func: controllers.account.ads
    });

    routes.add({
        uri: '/account/ads/delete-logo/:id',
        func: controllers.account.deleteBrandLogo
    });

    routes.add({
        uri: '/account/ads/delete',
        func: controllers.account.deleteBrand
    });

    routes.add({
        uri: '/account/ads/:id',
        func: controllers.account.brand
    });
    ...
    routes.add({
        ...
        method: 'post',
        fileUpload: true,
        func: controllers.account.updateBrand
    });

    routes.add({
        uri: '/account/ads/create',
        func: controllers.account.adsCreateView
    });
    ...
    routes.add({
        ...
        method: 'post',
        fileUpload: true,
        func: controllers.account.adsCreate
    });
